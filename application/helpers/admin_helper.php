 ...
 */
 ...
 function send_mail($username, $email, $forgot)
{
                ...
                <div class='container'>
                    <div class='content'>
                        ...
                        <div class='message'>
                            ...
                            <h1>" . $forgot . "</h1>
                            <p>We are here to serve you. Thanks for trusting Marie ERP.</p>
                        </div>
                        <div class='message'>
                        <p>Hello " . $username . ",</p>
                        <p>Enter this code to complete your account verification.</p>
                        <h1>" . $code . "</h1>
                        <p>We are here to serve you. Thanks for trusting Marie ERP.</p>
                    </div>
                        <div class='footer'>
                            <p>Regards,<br>The Marie ERP Team</p>
                        </div>
                    </div>
                </div>
            </body>
 ...
 function sendMail($username,$email,$code){
    ...
    try{
        ...
        $mail->addAddress($email);
        $mail->isHTML(true);
        $mail->Subject = 'Here\'s your PIN '.$code;
        $mail->Body = "
        <!DOCTYPE html>
        <html>
        <head>
