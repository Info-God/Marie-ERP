...
<div class="modal fade" id="edit_row" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <?php #echo form_open(admin_url('sales/row'),array('id'=>'sales_row_form')); ?>
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php $value = (isset($menu_data[$i]['Category']) ? $menu_data[$i]['Category'] : '');
                        echo render_select('categories', get_categories(), array('category', 'category'), 'Category', $value);
                        $value = (isset($menu_data[$i]['Item_Name']) ? $menu_data[$i]['Item_Name'] : '');
                        echo render_select('items', get_items(), array('item', 'item'), 'Item', $value);
                        ?>
                        <?php $value = (isset($menu_data[$i]['Total_Unit_Sales_Volume']) ? $menu_data[$i]['Total_Unit_Sales_Volume'] : ''); ?>
