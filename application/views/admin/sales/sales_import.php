...
<div class="modal fade" id="import_sales" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    ...
    <?php #echo form_open_multipart(admin_url('sales/sales_import'), array('id' => 'import_form')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php $value = (isset($months) ? $months : '');
                        echo render_select('months', get_months(), array('name', 'name'), 'Month', $value);
                        ?>
                    </div>
                </div>
            </div>
