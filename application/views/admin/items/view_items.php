                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <?php if ($has_permission_create) { ?>
                                <a href="#" onclick="new_service(); return false; " class="btn btn-info mright5"><?php echo 'New Items'; ?></a>
                            <?php } ?>
                            <?php if ($method == "validate") { ?>
                                <a href="<?php echo admin_url('items') ?>" class="btn btn-info mright5"><?php echo 'Items'; ?></a>
                            <?php } else { ?>
                                <a href="<?php echo admin_url('items/validate') ?>" class="btn btn-info mright5"><?php echo 'Validate'; ?></a>
                            <?php } ?>
                        </div>
...
<?php $this->load->view('admin/items/add_items'); ?>
<?php init_tail(); ?>
<script>
    $(function() {
    ...
    function initKnowledgeBaseTableArticles() {
        ...
        initDataTable('.table-articles', window.location.href, undefined, undefined, KB_Articles_ServerParams, [0, 'desc']);
    }
</script>
</body>
