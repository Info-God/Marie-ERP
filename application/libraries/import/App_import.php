...
abstract class App_import
{
     ...
     * @var integer
     */
    private $warningOnTotalRows = 1000;
     ...
     * @var integer
     */
    protected $maxSimulationRows = 1000;
    ...
    public function downloadSampleFormHtml()
    {
        ...
        $form .= '<button type="submit" class="btn btn-success">Download Sample File</button>';
        $form .= '<hr />';
        $form .= form_close();
    ...
    public function createSampleTableHtml($simulation = false)
    {
        ...
        /**
     * Create sample table for sample data and simulation table results for Sales import
     * @param  boolean $simulation where the table data should be taken from simultion data
     * @return string
     */
    public function createSampleTableInHtml($simulation = false)
    {
        $totalFields = 0;
        $allFields   = [];
        $dbFieldKeys = [];
